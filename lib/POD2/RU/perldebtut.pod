...
Во-первых есть несколько вещей, которые вы можете сделать, чтобы сделать вашу жизнь намного больше
просто, когда речь заходит о отладки perl программ, без использования
отладчика на всех. Чтобы продемонстрировать, вот простой скрипт, с именем «hello»,
проблема:
