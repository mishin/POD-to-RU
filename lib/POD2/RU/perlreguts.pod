...
Это B<Не> определение API, это внутреннее руководство для тех, кто хочет хачить
 регекс движок, или хочет понять, как он работает. Читатели
...
, определенных на миниязыке, а затем применяет эти ограничения к
