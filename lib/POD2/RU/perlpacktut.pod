...
в двоичном представлении? Одна хорошая причина, ввода и вывода доступ
Некоторые файла, устройство, или сетевое подключение, whereby этот двоичный файл
представление является либо вынужден на вас или будет дать вам некоторую пользу
в обработке. Другой причиной передача данных в некоторых системный вызов
не доступен как функции Perl: C <syscall>необходимо предоставить
параметры, хранящиеся в то, что это происходит в программе C. Даже текст обработки
(как показано в следующем разделе) могут быть упрощены с разумное использование
