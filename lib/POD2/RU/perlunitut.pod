...
символы, просто байты. Все коммуникации с внешним миром (что-либо
...
вы должны указать целевую кодировку, например С<iso-8859-1> или С<UTF-8>.
...
Чтобы декодировать, вы должны знаеть, какая кодировка используется на этапе кодирования.
