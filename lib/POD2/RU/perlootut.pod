...
большую часть работы. Этот минимализм имел много смысла в 1994 году, но годы, начиная 
с Perl 5.0 мы увидели появление ряда общих шаблонов в Perl OO. К счастью гибкость Perl 
 позволяет создавать богатые и процветающие экосистемы Perl OO.
...
Понимание концепций будет сделать его гораздо легче читать и писать объектно
ориентированного кода. Если вы уже знакомы с этими терминами, должны по-прежнему 
обезжиренное этот раздел, так как он объясняет каждое понятие с точки зрения 
осуществления OO Perl.
