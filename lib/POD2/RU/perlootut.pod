...
но объект может быть экземпляром любого типа данных Perl (скалярны,
массивы, и т.д.). Превращение структуру простых данных в объект 
...
с объектом. Вы можете думать о методе как о вещи, которую что объект может делать.
