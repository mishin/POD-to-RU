...
Глоссарий терминов (технических и иных), используемых в Perl
документации, происходит от Глоссария  I<Programming
Perl>, четвертое издание. Слова или фразы, выделенные жирным шрифтом определены где-либо в
этот глоссарии.

Другие полезные источники включают в себя Глоссарий Unicode L<http://unicode.org/glossary/>,
бесплатный он-лайн словарь по компьютерам L<http://foldoc.org/>,
файл Жаргона L<http://catb.org/~esr/jargon/>,
и Википедию L<http://www.wikipedia.org/>.
